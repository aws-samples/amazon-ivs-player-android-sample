...
object Configuration {
    ...
    const val LIVE_OPTION = "Live stream Landscape"
    const val RECORDED_OPTION = "Recorded video Landscape"
    const val LIVE_LANDSCAPE_LINK = "https://fcc3ddae59ed.us-west-2.playback.live-video.net/api/video/v1/us-west-2.893648527354.channel.DmumNckWFTqz.m3u8"
